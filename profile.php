...
<!-- Mirrored from storage.googleapis.com/theme-vessel-items/checking-sites-2/trek-html/HTML/main/my-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Nov 2023 12:56:39 GMT -->
<head>
    <!-- Google Tag Manager -->
            ...
            <div class="dashboard-sidebar col-lg-3 col-md-12 col-sm-12 col-pad">
                <div class="dashboard-nav d-none d-xl-block d-lg-block">
                    <div class="dashboard-nav-inner-2">
                        ...
                        <h4>Account</h4>
                        <ul>
                            <li class="active"><a href="my-profile.html"><i class="flaticon-user"></i>My Profile</a></li>
                            ...
                            <div class="dashboard-message contact-1 bdr clearfix">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3">
                                        <div class="my-photo">
                                            <img src="assets/img/avatar/avatar-2.jpg" alt="avatar" class="img-fluid">
                                        </div>
                                    </div>
                                    ...
                                    <div class="dashboard-message contact-2">
                                        <form action="#" method="GET" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="send-btn">
                                                        <button type="submit" class="btn btn-color btn-md btn-message">Change Password</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
