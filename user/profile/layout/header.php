                    ...
                    <div class="dashboard-nav d-none d-xl-block d-lg-block">
                        <div class="dashboard-nav-inner-2">
                            ...
                            <ul>
                                ...
                                <li><a href="profile.php?page=messages"><i class="flaticon-mail"></i> Messages <span
                                            class="nav-tag">2</span></a></li>
                                <li><a href="profile.php?page=bookings"><i class="flaticon-timetable"></i> Bookings</a>
                                </li>
                            </ul>
                            <h4>Listings</h4>
                            <ul>
                                <li><a href="profile.php?page=listings"><i class="flaticon-bullet"></i>My Listing</a>
                                </li>
                                <li><a href="profile.php?page=reviews"><i class="flaticon-star"></i>Reviews</a></li>
                                <li><a href="profile.php?page=bookmarks"><i class="flaticon-heart"></i>Bookmarks</a>
                                </li>
                                <li><a href="profile.php?page=add-listing"><i class="flaticon-plus"></i>Add Listing</a>
                                </li>
                            </ul>
                            <h4>Account</h4>
                            <ul>
