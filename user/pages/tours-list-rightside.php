    ...
    <div class="container">
        <div class="breadcrumb-area">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="active">Tours Listing</li>
            </ul>
        </div>
    </div>
</div>
...
<!-- Tours list rightside start -->
<div class="tours-list-rightside content-area-2">
    <div class="container">
        <div class="row">
                    ...
                    <div class="row clearfix">
                        <div class="col-xl-4 col-lg-5 col-md-5 col-sm-5">
                            <h4>
                                ...
                                <span class="heading">Tours List</span>
                            </h4>
                        </div>
                        ...
                        <div class="col-xl-5 col-lg-6 col-md-5 col-pad">
                            <div class="item-thumbnail">
                                <a href="tours-details.html" class="item-img">
                                    ...
                                    <img src="assets/img/property-16.jpg" alt="tours-list" class="img-fluid">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-5 col-lg-6 col-md-5 col-pad">
                            <div class="item-thumbnail">
                                <a href="tours-details.html" class="item-img">
                                    ...
                                    <img src="assets/img/property-17.jpg" alt="tours-list" class="img-fluid">
                                </a>
                            </div>
                        </div>
                        <div class="col-xl-7 col-lg-6 col-md-7 col-pad">
                        ...
                        <div class="col-xl-5 col-lg-6 col-md-5 col-pad">
                            <div class="item-thumbnail">
                                <a href="tours-details.html" class="item-img">
                                    ...
                                    <img src="assets/img/property-18.jpg" alt="tours-list" class="img-fluid">
                                </a>
                            </div>
                        </div>
                        <div class="col-xl-7 col-lg-6 col-md-7 col-pad">
                            <div class="detail">
                                <!-- title -->
                                <h1 class="title">
                                    <a href="tours-details.html">Travel To Thailand</a>
                                </h1>
                                <!-- Location -->
                                <div class="location">
                                    <a href="tours-details.html">
