    ...
    <div class="container">
        <div class="breadcrumb-area">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="active">Tours Detail</li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div id="itemDetailsSlider" class="carousel item-details-sliders slide mb-40">
                    ...
                    <div class="carousel-inner">
                        <div class="active item carousel-item" data-slide-number="0">
                            <img src="assets/img/property-5.jpg" class="img-fluid" alt="photo-4">
                        </div>
                        <div class="item carousel-item" data-slide-number="1">
                            <img src="assets/img/property-3.jpg" class="img-fluid" alt="photo-4">
                        </div>
                        <div class="item carousel-item" data-slide-number="2">
                            <img src="assets/img/property-1.jpg" class="img-fluid" alt="photo-4">
                        </div>
                        <div class="item carousel-item" data-slide-number="4">
                            <img src="assets/img/property-2.jpg" class="img-fluid" alt="photo-4">
                        </div>
                        <div class="item carousel-item" data-slide-number="5">
                            <img src="assets/img/property-6.jpg" class="img-fluid" alt="photo-4">
                        </div>
                    </div>
                    ...
                    <ul class="carousel-indicators smail-item list-inline nav nav-justified">
                        <li class="list-inline-item active">
                            <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#itemDetailsSlider">
                                <img src="assets/img/property-5.jpg" class="img-fluid" alt="photo-5">
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a id="carousel-selector-1" data-slide-to="1" data-target="#itemDetailsSlider">
                                <img src="assets/img/property-3.jpg" class="img-fluid" alt="photo-5">
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a id="carousel-selector-2" data-slide-to="2" data-target="#itemDetailsSlider">
                                <img src="assets/img/property-1.jpg" class="img-fluid" alt="photo-5">
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a id="carousel-selector-3" data-slide-to="3" data-target="#itemDetailsSlider">
                                <img src="assets/img/property-2.jpg" class="img-fluid" alt="photo-5">
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a id="carousel-selector-4" data-slide-to="4" data-target="#itemDetailsSlider">
                                <img src="assets/img/property-6.jpg" class="img-fluid" alt="photo-5">
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="sidebar ml-20">
                    ...
                    <div class="widget search-area2 d-none d-xl-block d-lg-block">
                        <h5 class="sidebar-title">Book This Tour</h5>
                        <form class="inline-search-area" method="GET">
                            <div class="form-group search-col">
                                <input type="text" class="form-control" placeholder="Hotel, City.....">
                                <i class="flaticon-localization icon-append"></i>
