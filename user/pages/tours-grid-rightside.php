...
<!-- Tours grid rightside start -->
<div class="tours-grid-rightside content-area-2">
    <div class="container">
        <div class="row">
                    ...
                    <div class="row clearfix">
                        <div class="col-xl-4 col-lg-5 col-md-5 col-sm-5">
                            <h4>
                                ...
                                <span class="heading">Tours Grid</span>
                            </h4>
                        </div>

                        <div class="col-xl-8 col-lg-7 col-md-7 col-sm-7">
                            <div class="sorting-options clearfix">
                                <a href="tours-list-rightside.html" class="change-view-btn"><i class="fa fa-th-list"></i></a>
                                <a href="tours-grid-rightside.html" class="change-view-btn active-view-btn"><i class="fa fa-th-large"></i></a>
                            </div>
                        ...
                        <div class="item-box">
                            <div class="item-thumbnail">
                                <a href="tours-details.html" class="item-img">
                                    ...
                                    <img src="assets/img/property-2.jpg" alt="tours" class="img-fluid">
                                </a>
                            </div>
                            <div class="detail">
                                <h1 class="title">
                        ...
                        <div class="item-box">
                            <div class="item-thumbnail">
                                <a href="tours-details.html" class="item-img">
                                    ...
                                    <img src="assets/img/property-5.jpg" alt="tours" class="img-fluid">
                                </a>
                            </div>
                            <div class="detail">
                                <h1 class="title">
                        ...
                        <div class="item-box">
                            <div class="item-thumbnail">
                                <a href="tours-details.html" class="item-img">
                                    ...
                                    <img src="assets/img/property-6.jpg" alt="tours" class="img-fluid">
                                </a>
                            </div>
                            <div class="detail">
                                <h1 class="title">
                                    <a href="tours-details.html">You Sould Visit Indea</a>
                                </h1>
                                <div class="location">
                                    <a href="tours-details.html">
                                        <i class="flaticon-localization"></i>2726 Shinn Street, New York
                        ...
                        <div class="pagination-box">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    ...
                                    <li class="page-item"><a class="page-link active" href="tours-grid-rightside.html">1</a></li>
                                    <li class="page-item"><a class="page-link" href="tours-grid-leftside.html">2</a></li>
                                    <li class="page-item"><a class="page-link" href="tours-grid-fullwidth.html">3</a></li>
                                    <li class="page-item"><a class="page-link" href="#"><span aria-hidden="true">»</span></a></li>
                                </ul>
                            </nav>
                        </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="sidebar ml-20">
                    ...
                    <div class="widget search-box">
                        <h5 class="sidebar-title">Search Tour</h5>
