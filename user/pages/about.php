...
<div class="about-us content-area-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7 align-self-center about-right">
                <div class="row">
...
<!-- Counters start -->
<div class="counters overview-bgi" style="background-image: url(assets/img/simple-content.jpg)">
    <div class="container">
        <div class="row">
...
<div class="services content-area-2">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 d-none d-xl-block d-lg-block">
                <div class="services-info-3">
