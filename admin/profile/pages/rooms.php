                            ...
                            <table class="manage-table">
                                ...
                                <tr class="responsive-table">
                                    ...
                                    <td class="title-container">
                                        ...
                                        <h5 class="d-none d-xl-block d-lg-block d-md-block"><i class="fa fa-map-marker"></i> 123 Kathal St. Tampa City, </h5>
                                ...
                                <tr class="responsive-table">
                                    <td class="listing-photoo">
                                        <img src="assets/img/property-10.jpg" alt="listing-photo" class="img-fluid">
                                    </td>
                                    <td class="title-container">
                                ...
                                <tr class="responsive-table">
                                    <td class="listing-photoo">
                                        <img src="assets/img/property-3.jpg" alt="listing-photo" class="img-fluid">
                                    </td>
                                    <td class="title-container">
                                        <h2><a href="#">Australia Sydney City</a></h2>
                                        <h5 class="d-none d-xl-block d-lg-block d-md-block"><i class="fa fa-map-marker"></i> 123 Kathal St. Tampa City, </h5>
                                        <h6 class="table-property-price">$900 / monthly</h6>
                                    </td>
                                    <td class="expire-date">4.01.2018</td>
                                ...
                                <tr class="responsive-table">
                                    <td class="listing-photoo">
                                        <img src="assets/img/property-8.jpg" alt="listing-photo" class="img-fluid">
                                    </td>
                                    <td class="title-container">
