...
<!-- Mirrored from storage.googleapis.com/theme-vessel-items/checking-sites-2/trek-html/HTML/main/hotels-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Nov 2023 14:14:13 GMT -->
<head>
    <!-- Google Tag Manager -->
                        ...
                        <ul class="navbar-nav ml-auto">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">List Layout</a>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="tours-list-rightside.html">Right Sidebar</a></li>
                                            <li><a class="dropdown-item" href="tours-list-leftside.html">Left Sidebar</a></li>
                                            <li><a class="dropdown-item" href="tours-list-fullwidth.html">Fullwidth</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Grid Layout</a>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="tours-grid-rightside.html">Right Sidebar</a></li>
                                            <li><a class="dropdown-item" href="tours-grid-leftside.html">Left Sidebar</a></li>
                                            <li><a class="dropdown-item" href="tours-grid-fullwidth.html">Fullwidth</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Tours Detail</a>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="tours-details.html">Tours Detail 1</a></li>
                                            <li><a class="dropdown-item" href="tours-details-2.html">Tours Detail 2</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown active">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">List Layout</a>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="hotels-list-rightside.html">Right Sidebar</a></li>
                                            <li><a class="dropdown-item" href="hotels-list-leftside.html">Left Sidebar</a></li>
                                            <li><a class="dropdown-item" href="hotels-list-fullwidth.html">Fullwidth</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Grid Layout</a>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="hotels-grid-rightside.html">Right Sidebar</a></li>
                                            <li><a class="dropdown-item" href="hotels-grid-leftside.html">Left Sidebar</a></li>
                                            <li><a class="dropdown-item" href="hotels-grid-fullwidth.html">Fullwidth</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Hotels Detail</a>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="hotels-details.html">Hotels Detail 1</a></li>
                                            <li><a class="dropdown-item" href="hotels-details-2.html">Hotels Detail 2</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-lg-3">
                                                <div class="megamenu-section">
                                                    <h6 class="megamenu-title">Pages #1</h6>
                                                    <a class="dropdown-item" href="about.html">About</a>
                                                    <a class="dropdown-item" href="agent.html">Agent</a>
                                                    <a class="dropdown-item" href="contact.html">Contact</a>
                                                    <a class="dropdown-item" href="tours-list-rightside.html">Tours List</a>
                                                    <a class="dropdown-item" href="hotels-list-rightside.html">Hotels List</a>
                                                    <a class="dropdown-item" href="blog-single-sidebar-right.html">Blog</a>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-lg-3">
                                                <div class="megamenu-section">
                                                    <h6 class="megamenu-title">Pages #2</h6>
                                                    <a class="dropdown-item" href="wishlist.html">Wishlist</a>
                                                    <a class="dropdown-item" href="help.html">help Section</a>
                                                    <a class="dropdown-item" href="invoice.html">invoice</a>
                                                    <a class="dropdown-item" href="payment-method.html">Payment Method</a>
                                                    <a class="dropdown-item" href="cart-1.html">Cart Page 1</a>
                                                    <a class="dropdown-item" href="cart-2.html">Cart Page 2</a>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-lg-3">
                                                <div class="megamenu-section">
                                                    <h6 class="megamenu-title">Pages #3</h6>
                                                    <a class="dropdown-item" href="gallery.html">Gallery</a>
                                                    <a class="dropdown-item" href="masonry-filtering.html">Masonry Filtering</a>
                                            ...
                                            <div class="col-sm-6 col-lg-3">
                                                <div class="megamenu-section">
                                                    <h6 class="megamenu-title">Pages #4</h6>
                            ...
                            <li class="nav-item dropdown">
                                <a href="dashboard.html" class="nav-link">User Panel</a>
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li class="nav-item dropdown">
                                <a href="cart-1.html" class="nav-link h-icon">
                ...
                <div id="itemDetailsSlider" class="carousel item-details-sliders slide mb-40">
                    ...
                    <ul class="carousel-indicators smail-item list-inline nav nav-justified">
                        <li class="list-inline-item active">
                            <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#itemDetailsSlider">
                    ...
                    <ul class="comments">
                        <li>
                            ...
                            <div class="media dashboard-message">
                                ...
                                <div class="media-body dashboard-message-text">
                                    <h5>Karen Paran - <span>12 March 2022</span> <span class="pull-right new">Reply</span></h5>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since</p>
                                    <span class="reply-mail clearfix">Reply : <a href="mailto:info@themevessel.com">info@themevessel.com</a></span>
                                </div>
                            </div>
...
<footer class="footer">
    <div class="container footer-inner">
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="contact-info">
                        <li>
                            Address: 20/F Green Road, Dhanmondi
                        </li>
                        <li>
            ...
            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="links">
                        <li>
                            <a href="tours-list-rightside.html"><i class="fa fa-angle-right"></i>Tours</a>
                        </li>
                        <li>
                            <a href="hotels-list-rightside.html"><i class="fa fa-angle-right"></i>Hotels</a>
                        </li>
                        <li>
                            <a href="about.html"><i class="fa fa-angle-right"></i>About us</a>
                        </li>
                        <li>
                            <a href="my-profile.html"><i class="fa fa-angle-right"></i>My Profile</a>
                        </li>
                        <li>
                            <a href="blog-single-sidebar-right.html"><i class="fa fa-angle-right"></i>Blog</a>
                        </li>
                        <li>
        ...
        <div class="row">
            <div class="col-xl-12">
                <p class="copy">&copy;  2018 <a href="../../../../../../themevessel.com/index.html" target="_blank">Theme Vessel</a>. Trademarks and brands are the property of their respective owners.</p>
            </div>
        </div>
    </div>
</footer>
        ...
        <div class="off-canvas-content">
            ...
            <aside class="canvas-widget">
                <ul class="menu">
                    ...
                    <li class="menu-item"><a href="tours-list-rightside.html">Tours</a></li>
                    <li class="menu-item"><a href="hotels-list-rightside.html">Hotels</a></li>
